...
## Playbook Header
Playbook ID: 02_playbooks__financial_services__payments__solutions__solution_index_md
Version: 1.0
Status: draft
...
| # | Solution | Sub-Specs |
|---|----------|-----------|
| 1 | MSB_INTAKE_AND_REGISTRATION | New MSB (Domestic) · New MSB (Foreign-Based / Canada-Facing) · Business Model Change / Scope Expansion · First-Time AML/KYC Policy Drafting |
...
| 23 | MSB_PRE_REGISTRATION_TRIAGE | Standard · Complex · Urgent |
| 24 | MSB_POST_REGISTRATION_TRIAGE | Post-Initial Registration · Post-Change · Periodic Check-In · Pre-Effectiveness Review |
